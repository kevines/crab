...
//        sheet.protectSheet("your password");
        ...
        commentFormatter.setColor(IndexedColors.BLACK.getIndex());
        cellStyle.setFont(commentFormatter);
    ...
    public void cell(int cellNum, Cell cell) {
        ...
        if(cell.getRow().getRowNum()==0){
            ...
            Font commentFormatter = workbook.createFont();
            commentFormatter.setFontName("宋体");
            commentFormatter.setBold(true);
            //设置字体大小
            commentFormatter.setFontHeightInPoints((short)14);
            commentFormatter.setColor(IndexedColors.BLUE.getIndex());
            header.setFont(commentFormatter);
            header.setAlignment(HorizontalAlignment.CENTER);
            header.setVerticalAlignment(VerticalAlignment.CENTER);//垂直居中
