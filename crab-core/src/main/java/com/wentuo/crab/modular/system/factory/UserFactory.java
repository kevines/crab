 ...
 */
package com.wentuo.crab.modular.system.factory;

import cn.hutool.core.bean.BeanUtil;
import com.wentuo.crab.modular.system.entity.User;
import com.wentuo.crab.modular.system.model.UserDto;
...
public class UserFactory {
     ...
     * 根据请求创建实体
     */
    public static User createUser(UserDto userDto, String md5Password) {
        if (userDto == null) {
            return null;
        } else {
            User user = new User();
