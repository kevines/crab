package com.wentuo.crab.core.pay.common.api;


import com.wentuo.crab.core.pay.common.bean.RefundOrder;
import com.wentuo.crab.core.pay.common.bean.TransactionType;
import com.wentuo.crab.core.pay.common.bean.TransferOrder;
import com.wentuo.crab.core.pay.common.http.HttpConfigStorage;
import com.wentuo.crab.core.pay.common.http.HttpRequestTemplate;
...
public abstract class BasePayService<PC extends PayConfigStorage> implements PayService<PC>  {
    ...
    protected String authorizationString(String user, String password) {
        ...
        try {
            base64ClientID = com.wentuo.crab.core.pay.common.util.sign.encrypt.Base64.encode(String.format("%s:%s", user , password).getBytes("UTF-8"));
    ...
    /**
     * @param tradeNoOrBillDate 支付平台订单号或者账单类型， 具体请 类型为{@link String }或者 {@link Date }，类型须强制限制，类型不对应则抛出异常
