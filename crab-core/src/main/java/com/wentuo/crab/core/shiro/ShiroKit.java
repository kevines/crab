 ...
 */
package com.wentuo.crab.core.shiro;
...
public class    ShiroKit {
     ...
     */
    public static ShiroUser createShiroUser(AppUser appUser) {
        ShiroUser shiroUser = new ShiroUser();

        if (appUser == null) {
            return shiroUser;
        }
        shiroUser.setId(appUser.getId());
        shiroUser.setUserId(appUser.getUserId());
        shiroUser.setPhone(appUser.getPhone());
        shiroUser.setName(appUser.getName());
        shiroUser.setRealName(appUser.getRealName());
        shiroUser.setPhoto(appUser.getPhoto());
        return shiroUser;
    }
