...
import com.wentuo.crab.modular.system.mapper.LoginLogMapper;
import com.wentuo.crab.modular.system.mapper.OperationLogMapper;
...
public class LogTaskFactory {
    ...
    public static TimerTask exceptionLog(final Object userId, final Exception exception) {
        return new TimerTask() {
            @Override
            public void run() {
